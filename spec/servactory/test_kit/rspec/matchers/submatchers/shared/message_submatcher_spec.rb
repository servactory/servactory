...
RSpec.describe Servactory::TestKit::Rspec::Matchers::Submatchers::Shared::MessageSubmatcher do
  ...
  describe "#description" do
    it "includes 'message'" do
      expect(subject.description).to include("message")
    end
  end
  ...
  describe "#matches?" do
    ...
    context "when message doesn't match" do
      subject { described_class.new(context, "Wrong message") }
  ...
  describe "#failure_message" do
    context "when match fails" do
      ...
      it "includes actual message" do
        expect(subject.failure_message).to include("Config schema validation failed")
      end
    end
  end
end
