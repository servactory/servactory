...
RSpec.describe Usual::Inclusion::Example9 do
  describe ".call!" do
    ...
    context "when the input arguments are valid" do
      describe "and the data required for work is also valid" do
        ...
        it "returns the expected values", :aggregate_failures do
          ...
          expect(result.event).to be_a(Usual::Inclusion::Example9::Event)
          ...
          it "returns expected error" do
            expect { perform }.to(
              raise_error(
                ...
                "[Usual::Inclusion::Example9] Wrong value in `event_name`, must be one of " \
