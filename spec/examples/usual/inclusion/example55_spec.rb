...
RSpec.describe Usual::Inclusion::Example55 do
  describe ".call!" do
      ...
      describe "and the data required for work is also valid" do
        ...
        describe "and the value of `event_name` is passed" do
          it "returns the expected values", :aggregate_failures do
            ...
            expect(result.event).to be_a(Usual::Inclusion::Example55::Event)
          ...
          it "returns expected error" do
            expect { perform }.to(
              raise_error(
                ...
                "[Usual::Inclusion::Example55] Wrong value in `event_name`, must be one of " \
