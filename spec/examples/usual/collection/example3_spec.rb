...
RSpec.describe Usual::Collection::Example3, skip: true do
  describe ".call!" do
          ...
          it "returns expected error" do
            expect { perform }.to(
              raise_error(
                ...
                "[Usual::Collection::Example3] Input `invoice_numbers` must \"be_6_characters\""
              )
            )
          end
        end
        ...
        describe "because one element has the wrong type" do
          ...
          it "returns expected error" do
            expect { perform }.to(
              raise_error(
                ApplicationService::Errors::InputError,
                "[Usual::Collection::Example3] Wrong type in input collection `invoice_numbers`, " \
        ...
        describe "because one element is empty" do
          ...
          it "returns expected error" do
            expect { perform }.to(
              raise_error(
                ApplicationService::Errors::InputError,
                "[Usual::Collection::Example3] Required element in input collection `invoice_numbers` is missing"
              )
            )
          end
        end
