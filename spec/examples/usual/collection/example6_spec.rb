...
RSpec.describe Usual::Collection::Example6 do
  describe ".call!" do
          ...
          it "returns expected error" do
            expect { perform }.to(
              raise_error(
                ...
                "[Usual::Collection::Example6] Wrong type in input collection `ids`, expected `String`, got `Integer`"
              )
            )
          end
        end
        ...
        describe "because one element is empty" do
          ...
          it "returns expected error" do
            expect { perform }.to(
              raise_error(
                ApplicationService::Errors::InputError,
                "[Usual::Collection::Example6] Required element in input collection `ids` is missing"
              )
            )
          end
        end
