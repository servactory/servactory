...
RSpec.describe Usual::Collection::Example21 do
  describe ".call!" do
          ...
          it "returns expected error" do
            expect { perform }.to(
              raise_error(
                ...
                "[Usual::Collection::Example21] Wrong type in input collection `ids`, expected `String`, got `Integer`"
              )
            )
          end
        end
        ...
        describe "because one element is empty" do
          ...
          it "returns expected error" do
            expect { perform }.to(
              raise_error(
                ApplicationService::Errors::InputError,
                "[Usual::Collection::Example21] Required element in input collection `ids` is missing"
              )
            )
          end
        end
