...
RSpec.describe Usual::Collection::Example17, type: :service do
  describe ".call!" do
    ...
    context "when the input arguments are invalid" do
      it { expect { perform }.to have_input(:letters).direct(attributes).type(Array).consists_of(String).required }
    end
  end
