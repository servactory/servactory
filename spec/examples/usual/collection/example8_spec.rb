...
RSpec.describe Usual::Collection::Example8, type: :service do
  describe ".call!" do
          ...
          it "returns expected error" do
            expect { perform }.to(
              raise_error(
                ...
                "[Usual::Collection::Example8] Wrong type in input collection `ids`, expected `String`, got `Integer`"
              )
            )
          end
        end
        ...
        describe "because one element is empty" do
          ...
          it "returns expected error" do
            expect { perform }.to(
              raise_error(
                ApplicationService::Exceptions::Input,
                "[Usual::Collection::Example8] Required element in input collection `ids` is missing"
              )
            )
          end
        end
