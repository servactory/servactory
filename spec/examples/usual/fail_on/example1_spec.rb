...
RSpec.describe Usual::FailOn::Example1, type: :service do
  describe ".call!" do
            ...
            expect { perform }.to(
              raise_error do |exception|
                ...
                expect(exception.meta).to(
                  match(original_exception: be_an_instance_of(Usual::FailOn::Example1::LikeAnActiveRecordException))
                )
              end
            )
          end
    ...
    context "when the input arguments are invalid" do
      it { expect(perform).to have_input(:invoice_number).type(String).required }
    end
  end
        ...
        describe "because invalid invoice number" do
          ...
          it "returns the expected value in `errors`", :aggregate_failures do
            ...
            expect(result.error).to an_object_having_attributes(
              ...
              meta: {
                original_exception: be_an_instance_of(Usual::FailOn::Example1::LikeAnActiveRecordException)
              }
            )
          end
        end
