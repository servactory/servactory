...
RSpec.describe Usual::Example11 do
  describe ".call!" do
          ...
          it "returns expected error" do
            expect { perform }.to(
              raise_error(
                ...
                "[Usual::Example11] Wrong type in input array `ids`, expected `String`"
              )
            )
          end
        end
        ...
        describe "because one element is empty" do
          ...
          it "returns expected error" do
            expect { perform }.to(
              raise_error(
                ApplicationService::Errors::InputArgumentError,
                "[Usual::Example11] Required element in input array `ids` is missing"
              )
            )
          end
        end
