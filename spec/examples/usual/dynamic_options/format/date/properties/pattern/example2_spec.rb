...
RSpec.describe Usual::DynamicOptions::Format::Date::Properties::Pattern::Example2, type: :service do
  describe ".call!" do
          ...
          it "returns expected error" do
            expect { perform }.to(
              raise_error(
                ...
                "[Usual::DynamicOptions::Format::Date::Properties::Pattern::Example2] " \
