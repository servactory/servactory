...
RSpec.describe Usual::DynamicOptions::Format::Date::Is::Example1, type: :service do
  describe ".call!" do
          ...
          it "returns expected error" do
            expect { perform }.to(
              raise_error(
                ...
                "[Usual::DynamicOptions::Format::Date::Is::Example1] Input `started_on` does not match `date` format"
              )
            )
          end
        end
