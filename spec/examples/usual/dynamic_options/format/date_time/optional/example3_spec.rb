...
RSpec.describe Usual::DynamicOptions::Format::DateTime::Optional::Example3, type: :service do
  describe ".call!" do
        ...
        it "returns expected error" do
          expect { perform }.to(
            raise_error(
              ...
              "[Usual::DynamicOptions::Format::DateTime::Optional::Example3] Output attribute `started_at` " \
