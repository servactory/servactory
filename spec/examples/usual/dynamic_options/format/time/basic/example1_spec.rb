...
RSpec.describe Usual::DynamicOptions::Format::Time::Basic::Example1, type: :service do
  describe ".call!" do
          ...
          it "returns expected error" do
            expect { perform }.to(
              raise_error(
                ...
                "[Usual::DynamicOptions::Format::Time::Basic::Example1] " \
    ...
    context "when the input arguments are invalid" do
      it { expect { perform }.to have_input(:started_at).simulation(attributes).type(String).required }
    end
  end
