...
RSpec.describe Usual::DynamicOptions::Format::Boolean::Properties::Pattern::Example1, type: :service do
  describe ".call!" do
        ...
        it "returns expected error" do
          expect { perform }.to(
            raise_error(
              ...
              "[Usual::DynamicOptions::Format::Boolean::Properties::Pattern::Example1] " \
