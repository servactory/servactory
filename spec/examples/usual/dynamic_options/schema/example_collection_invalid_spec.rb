...
RSpec.describe Usual::DynamicOptions::Schema::ExampleCollectionInvalid, type: :service do
  describe ".call!" do
    ...
    it "raises an error for invalid element in collection" do
      expect { perform }.to raise_error(ApplicationService::Exceptions::Input, "[Usual::DynamicOptions::Schema::ExampleCollectionInvalid] Wrong element in input collection `items`: required")
    end
