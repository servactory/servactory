...
RSpec.describe Usual::DynamicOptions::ConsistsOf::Example17, type: :service do
  describe ".call!" do
        ...
        it "returns expected error" do
          expect { perform }.to(
            raise_error(
              ...
              "[Usual::DynamicOptions::ConsistsOf::Example17] Wrong element type in input collection `ids`, " \
      ...
      describe "because one element is empty" do
        ...
        it "returns expected error" do
          expect { perform }.to(
            raise_error(
              ApplicationService::Exceptions::Input,
              "[Usual::DynamicOptions::ConsistsOf::Example17] Required element in input collection `ids` is missing"
            )
          )
        end
      end
