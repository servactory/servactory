...
RSpec.describe Usual::TestKit::Rspec::AllowServiceAsFailure::Example1, type: :service do
  describe ".call!" do
    ...
    describe "but the data required for work is invalid" do
      before do
        allow_service_as_failure(Usual::TestKit::Rspec::AllowServiceAsFailure::Example1Child) do
