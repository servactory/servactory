...
RSpec.describe Wrong::DynamicOptions::ConsistsOf::Example2, skip: "DELETE ME" do
  describe ".call!" do
        ...
        it "returns expected error" do
          expect { perform }.to(
            raise_error(
              ...
              "[Wrong::DynamicOptions::ConsistsOf::Example2] Wrong element type in internal attribute " \
