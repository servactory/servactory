  ...
  module InputArguments
    module Tools
      class Check
        ...
        def check_classes
          [
            ServiceFactory::InputArguments::Checks::Required,
            ServiceFactory::InputArguments::Checks::Type,
            ServiceFactory::InputArguments::Checks::Inclusion,
            ServiceFactory::InputArguments::Checks::Must
          ]
        end
        ...
        def raise_errors
          ...
          raise ServiceFactory.configuration.input_argument_error_class, @errors.first
        end
      end
    end
  end
