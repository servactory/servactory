...
module Servactory
  module InputAttributes
    class InputAttribute # rubocop:disable Metrics/ClassLength
      ...
      def add_basic_options_with(type:, options:)
        # Check Class: Servactory::InputAttributes::Checks::Required
        add_required_option_with(options)

        # Check Class: Servactory::InputAttributes::Checks::Type
        add_types_option_with(type)
        add_default_option_with(options)
        add_array_option_with(options)

        # Check Class: Servactory::InputAttributes::Checks::Inclusion
        add_inclusion_option_with(options)

        # Check Class: Servactory::InputAttributes::Checks::Must
      ...
      def add_required_option_with(options) # rubocop:disable Metrics/MethodLength
        collection_of_options << Option.new(
          name: :required,
          input: self,
          check_class: Servactory::InputAttributes::Checks::Required,
      ...
      def add_types_option_with(type)
        collection_of_options << Option.new(
          name: :types,
          input: self,
          check_class: Servactory::InputAttributes::Checks::Type,
      ...
      def add_inclusion_option_with(options) # rubocop:disable Metrics/MethodLength
        collection_of_options << Option.new(
          name: :inclusion,
          input: self,
          check_class: Servactory::InputAttributes::Checks::Inclusion,
          define_input_methods: [
            DefineInputMethod.new(
      ...
      def add_must_option_with(options) # rubocop:disable Metrics/MethodLength
        collection_of_options << Option.new(
          name: :must,
          input: self,
          check_class: Servactory::InputAttributes::Checks::Must,
          define_input_methods: [
            DefineInputMethod.new(
              name: :must_present?,
