  ...
  module ToolKit
    module DynamicOptions
      class MultipleOf < Must
        ...
        def common_condition_with(value:, option:, **_options)
          case value
        ...
        def message_for_input_with(service:, input:, value:, option_name:, option_value:, **_options) # rubocop:disable Metrics/MethodLength
        ...
        def message_for_internal_with(service:, internal:, value:, option_name:, option_value:, **_options) # rubocop:disable Metrics/MethodLength
        ...
        def message_for_output_with(service:, output:, value:, option_name:, option_value:, **_options) # rubocop:disable Metrics/MethodLength
