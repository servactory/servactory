  ...
  module TestKit
    module Rspec
      module AllowServiceFluentApi
        ...
        class Example18Child < ApplicationService::Base
        ...
        # Parent service (tested, calls child with parameters that have String keys)
        class Example18 < ApplicationService::Base
          ...
          def search
            params = ActiveSupport::HashWithIndifferentAccess.new(query: inputs.query)

            result = Example18Child.call(params)
